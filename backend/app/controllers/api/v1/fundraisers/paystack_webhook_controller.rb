        ...
        def handle_event(event)
          ...
          when "charge.success"
            if metadata[:premium_access]
              PaystackWebhook::Handlers::PremiumSubscriptionHandler.new(event[:data], event_type).call
            else
          ...
          when "subscription.create", "subscription.disable", "subscription.not_renew", "subscription.charge.failed"
            PaystackWebhook::Handlers::PremiumSubscriptionHandler.new(event[:data], event_type).call
