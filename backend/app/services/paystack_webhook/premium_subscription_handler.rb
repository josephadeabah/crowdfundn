  ...
  class PremiumSubscriptionHandler
    ...
    def handle_charge_success
      ...
      subscription.assign_attributes(
        ...
        paystack_email_token: email_token # ✅ Store the email token
      )
    ...
    def handle_subscription_create
      ...
      # ✅ Find the most recent subscription for this user and plan
      ...
      # ✅ Update with Paystack details including email token
      subscription.update!(
        paystack_subscription_code: subscription_code,
        paystack_email_token: email_token, # ✅ Store the email token from webhook
        auto_renew: true,
        status: 'active'
      )
