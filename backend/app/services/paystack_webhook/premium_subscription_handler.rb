  ...
  class PremiumSubscriptionHandler
    ...
    def handle_subscription_creation
      ...
      if existing_subscription
        Rails.logger.info "Subscription already exists: #{existing_subscription.id}"
        return 
      end
      ...
      subscription_attrs = {
        user: user,
        premium_plan: plan,
        paystack_subscription_code: subscription_code, # This is the critical field
        status: 'active',
        ...
        auto_renew: true,
        transaction_reference: "sub_#{subscription_code}" # Required field
      }
