...
Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'https://bantuhive.com'
  ...
  config.action_mailer.default_url_options = { host: 'localhost', port: 3000 } # Adjust for your setup
