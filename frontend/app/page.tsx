      ...
      <main className="max-w-7xl mx-auto">
        <div className="flex items-center justify-center">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1626624340240-aadc087844fa?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
