...
const ExternalDocumentCard: React.FC<ExternalDocumentCardProps> = ({
  ...
  <div className="flex items-center justify-between bg-gradient-to-r from-gray-50 to-white rounded-2xl p-6 border border-gray-200 hover:border-gray-300 transition-all duration-300 group w-full max-w-full">
    <div className="flex items-center gap-4 min-w-0 flex-1 max-w-[calc(100%-120px)]">
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="px-6 py-3 bg-gray-500 text-white rounded-xl hover:bg-gray-600 transition-colors font-medium flex items-center gap-2 group-hover:shadow-lg flex-shrink-0 ml-4 whitespace-nowrap"
    >
      View
      <FaExternalLinkAlt className="text-xs" />
    </a>
