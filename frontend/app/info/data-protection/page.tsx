...
const DataProtection = () => {
  const tableOfContents = [
    ...
    { id: 'retention', title: '10. Data Retention' },
    {
      ...
      title: '11. Fundraiser Accountability & Fund Misuse',
    },
  ...
  return (
    ...
    >
      ...
      <section id="fundraiser-accountability" className="policy-section">
        ...
        <p>
          BantuHive Ltd is committed to ensuring that all funds raised through
          our platform—whether through donations or investment crowdfunding—are
          used for their intended purposes. Misuse of funds constitutes a
          serious breach of trust and is subject to severe penalties under
          Ghanaian law.
        </p>

        <h3>11.1 Legal Framework for Fund Misuse in Ghana</h3>
        <p>
          Fund misuse on our platform may constitute criminal offenses under
          multiple Ghanaian laws:
        </p>
        <ul>
          <li>
            <strong>Criminal Offences Act, 1960 (Act 29):</strong> Fraud and
            obtaining money by false pretenses is punishable by imprisonment of
            up to 10 years under Sections 131-136.
          </li>
          <li>
            <strong>Anti-Money Laundering Act, 2020 (Act 1044):</strong>{' '}
            Misappropriation of funds may constitute money laundering,
            punishable by imprisonment of up to 10 years and/or a fine of up to
            7,500 penalty units.
          </li>
          <li>
            <strong>Securities Industry Act, 2016 (Act 929):</strong> For
            investment crowdfunding, misrepresentation or fraud is punishable by
            imprisonment of up to 10 years and fines as determined by the
            Securities and Exchange Commission (SEC).
          </li>
          <li>
            <strong>Companies Act, 2019 (Act 992):</strong> Directors and
            officers who misappropriate company funds face personal liability,
            disqualification, and criminal prosecution.
          </li>
          <li>
            <strong>Electronic Transactions Act, 2008 (Act 772):</strong> Cyber
            fraud and electronic deception carry penalties of up to 15 years
            imprisonment.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Provide accurate and truthful information about their campaign
            purpose
          </li>
          <li>
            Use funds exclusively for the stated purpose as described in the
            campaign
          </li>
          <li>Maintain detailed records of all fund expenditures</li>
          <li>
            Provide regular progress updates and financial accountability
            reports
          </li>
          <li>Respond promptly to donor/investor inquiries about fund usage</li>
          <li>
            Return unused funds to donors/investors or redirect them with proper
            consent
          </li>
        ...
        <p>
          BantuHive Ltd employs rigorous monitoring to detect and prevent fund
          misuse:
        </p>
        <ul>
          <li>
            <strong>Verification Checks:</strong> Enhanced due diligence on all
            fundraisers, including identity verification, address verification,
            and background checks where applicable.
          </li>
          <li>
            <strong>Fund Release Controls:</strong> Milestone-based fund
            releases for large campaigns, requiring proof of progress before
            subsequent disbursements.
          </li>
          <li>
            <strong>Expenditure Audits:</strong> Random and risk-based audits of
            fund usage, including requests for receipts, invoices, and bank
            statements.
          </li>
          <li>
            <strong>Whistleblower Mechanism:</strong> Secure reporting channels
            for donors, investors, and the public to report suspected misuse.
          </li>
          <li>
            <strong>Real-time Monitoring:</strong> Automated systems to detect
            suspicious patterns in fund withdrawals and usage.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Immediate Account Suspension:</strong> Upon substantiated
            allegations, the fundraiser's account and any pending disbursements
            will be frozen.
          </li>
          <li>
            <strong>Fund Recovery:</strong> BantuHive Ltd will pursue recovery
            of misused funds through all available legal means, including civil
            litigation and asset freezing orders.
          </li>
          <li>
            <strong>Criminal Referral:</strong> Cases of fraud will be reported
            to the Ghana Police Service (Economic and Organized Crime Office -
            EOCO) and the Attorney General's Department for prosecution.
          </li>
          <li>
            <strong>Civil Liability:</strong> Fundraisers will be liable for
            full restitution to donors, plus damages, interest, and legal costs.
          </li>
          <li>
            <strong>Platform Ban:</strong> Permanent prohibition from using
            BantuHive Ltd services, with information shared with other
            crowdfunding platforms as permitted by law.
          </li>
          <li>
            <strong>Public Disclosure:</strong> Publication of verified fraud
            cases on our platform and to relevant authorities to protect the
            public.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>SEC Reporting:</strong> Immediate notification to the
            Securities and Exchange Commission of Ghana for regulatory
            investigation and enforcement action.
          </li>
          <li>
            <strong>Investor Protection:</strong> Activation of any investor
            protection mechanisms, including escrow fund releases and insurance
            claims where applicable.
          </li>
          <li>
            <strong>Director Disqualification:</strong> Pursuit of court orders
            disqualifying directors from holding corporate positions under the
            Companies Act.
          </li>
          <li>
            <strong>Asset Freezing:</strong> Application for court orders to
            freeze personal and corporate assets of responsible parties.
          </li>
          <li>
            <strong>Criminal Prosecution:</strong> Referral for criminal
            prosecution for securities fraud, which may result in imprisonment
            and substantial fines.
          </li>
          <li>
            <strong>Credit Bureau Reporting:</strong> Reporting to credit
            reference bureaus, affecting the individual's ability to access
            financial services.
          </li>
        </ul>

        <h3>11.6 Dispute Resolution Process</h3>
        <p>When fund misuse is suspected, the following process applies:</p>
        <ul>
          <li>
            <strong>Step 1 - Investigation:</strong> BantuHive Ltd conducts a
            thorough internal investigation within 14 business days of receiving
            a complaint.
          </li>
          <li>
            <strong>Step 2 - Fundraiser Response:</strong> The fundraiser is
            given 7 business days to provide evidence of proper fund usage.
          </li>
          <li>
            <strong>Step 3 - Independent Review:</strong> For disputed cases, an
            independent review panel may be convened including legal and
            financial experts.
          </li>
          <li>
            <strong>Step 4 - Determination:</strong> A formal determination is
            issued with findings and remedial actions required.
          </li>
          <li>
            <strong>Step 5 - Enforcement:</strong> Penalties are enforced, and
            the matter is escalated to authorities if criminal conduct is
            identified.
          </li>
        </ul>
        ...
        <p>
          BantuHive Ltd fully cooperates with law enforcement and regulatory
          authorities:
        </p>
        <ul>
        ...
        <p>
          We maintain detailed records of all transactions and user activities
          for a minimum of 7 years to support any investigations or legal
          proceedings.
        </p>

        <h3>11.8 Donor and Investor Protections</h3>
        <p>
          BantuHive Ltd implements the following protections for donors and
          investors:
        </p>
        <ul>
          ...
          <li>
            Insurance coverage for verified fraud cases (subject to policy
            limits)
          </li>
          <li>
            Legal support for collective action against fraudulent fundraisers
          </li>
        </ul>
      </section>
