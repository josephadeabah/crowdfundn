          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Professional support designed to maximize your campaign's
                success and help you reach your funding goals faster.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Get personalized guidance from crowdfunding experts who
                  understand what makes campaigns successful in the African
                  market.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  24/7 technical support ensuring your campaign runs smoothly
                  with instant resolution of any platform issues.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Advanced marketing tools and expert guidance to amplify your
                  reach and attract more backers to your campaign.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-300">
                  Higher success rate for supported campaigns
                </p>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-400 mb-2">
                ...
                <p className="text-gray-300">
                  Average increase in funds raised
                </p>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-400 mb-2">
                ...
                <p className="text-gray-300">
                  Faster campaign funding goals reached
                </p>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-400 mb-2">
                ...
                <p className="text-gray-300">
                  Campaigns successfully supported
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Simple process to get the support you need
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Select the support level that matches your campaign goals
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Meet your support team and plan your strategy
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Get ongoing guidance and technical assistance
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Reach your funding goals with expert support
                </p>
              </div>
            </div>
          </div>
