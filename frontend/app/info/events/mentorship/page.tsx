...
import { Users, Target, Award, Heart, TrendingUp, MessageCircle, Calendar, Clock, Star } from "lucide-react";
...
const Mentorship = () => {
  const mentorshipPrograms = [
    {
      ...
      description: "Personalized mentorship focused on strategic business development and growth planning.",
      includes: [
    ...
    },
    {
      ...
      description: "Group mentorship program where entrepreneurs learn from each other under expert guidance.",
      includes: [
    ...
    },
    {
      ...
      currentMentees: 2,
      category: "FinTech",
      description: "Specialized mentorship for entrepreneurs in specific industries like FinTech, AgriTech, HealthTech.",
      includes: [
    ...
    },
    {
      ...
      description: "Mentorship program specifically designed for women entrepreneurs, addressing unique challenges and opportunities.",
      includes: [
      ...
      mentor: {
        ...
        companies: 2,
        exitValue: "GHS 40M+",
        expertise: ["Leadership", "Team Building", "Work-life Balance", "Fundraising"],
    ...
    },
    {
      ...
      description: "Intensive mentorship program for entrepreneurs under 30, focusing on rapid skill development and network building.",
      includes: [
      ...
      mentor: {
        ...
        companies: 3,
        exitValue: "GHS 20M+",
        expertise: ["Youth Development", "Technology", "Innovation", "Networking"],
    ...
    },
    {
      ...
      description: "Mentorship for entrepreneurs building businesses with strong social or environmental impact missions.",
      includes: [
      ...
      mentor: {
        ...
        companies: 2,
        exitValue: "GHS 30M+",
        expertise: ["Impact Measurement", "Sustainability", "Social Enterprise", "Grant Writing"],
  ...
  const testimonials = [
    {
      ...
      quote: "Dr. Asante's mentorship was transformational. His guidance helped us scale from 2 to 15 employees and secure our Series A funding.",
    ...
    },
    {
      ...
      quote: "Alex's expertise in FinTech regulation saved us months of trial and error. We launched 6 months ahead of schedule.",
    ...
    },
    {
      ...
      quote: "Grace helped me balance growing my business while being a mother. Her support was invaluable during our expansion phase.",
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case "Business Strategy": return "bg-blue-100 text-blue-800";
      case "Peer Learning": return "bg-green-100 text-green-800";
      case "FinTech": return "bg-purple-100 text-purple-800";
      case "Women-Focused": return "bg-pink-100 text-pink-800";
      case "Youth-Focused": return "bg-orange-100 text-orange-800";
      case "Impact-Focused": return "bg-teal-100 text-teal-800";
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Connect with experienced entrepreneurs and industry experts who will guide you through your entrepreneurial journey with personalized support and insights.
            </p>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-primary mb-2">GHS 25M+</div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Mentorship Programs</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose from our diverse mentorship programs designed to meet you where you are in your entrepreneurial journey.
            </p>
          </div>
          ...
          <Tabs defaultValue="all" className="max-w-6xl mx-auto">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {program.currentMentees}/{program.maxMentees} spots filled
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="bg-muted/50 p-3 rounded-lg">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">{program.mentor.title}</p>
                              </div>
                            ...
                            <p className="text-xs text-muted-foreground">{program.mentor.bio}</p>
                          </div>
                        </div>
            ...
            <TabsContent value="individual" className="mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {mentorshipPrograms.filter(p => p.format.includes("Individual")).map((program) => (
                  <Card key={program.id} className="border-border hover:shadow-lg transition-shadow">
                    <CardHeader>
            ...
            <TabsContent value="group" className="mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {mentorshipPrograms.filter(p => p.format.includes("Group")).map((program) => (
                  <Card key={program.id} className="border-border hover:shadow-lg transition-shadow">
                    <CardHeader>
                      <CardTitle className="text-xl">{program.title}</CardTitle>
                      <p className="text-sm text-muted-foreground">{program.description}</p>
            ...
            <TabsContent value="industry" className="mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {mentorshipPrograms.filter(p => ["FinTech", "Impact-Focused"].includes(p.category)).map((program) => (
                  <Card key={program.id} className="border-border hover:shadow-lg transition-shadow">
                    <CardHeader>
                      <CardTitle className="text-xl">{program.title}</CardTitle>
                      <p className="text-sm text-muted-foreground">{program.description}</p>
            ...
            <TabsContent value="demographic" className="mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {mentorshipPrograms.filter(p => ["Women-Focused", "Youth-Focused"].includes(p.category)).map((program) => (
                  <Card key={program.id} className="border-border hover:shadow-lg transition-shadow">
                    <CardHeader>
                      <CardTitle className="text-xl">{program.title}</CardTitle>
                      <p className="text-sm text-muted-foreground">{program.description}</p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                See how our mentorship programs have transformed businesses across Africa
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Simple steps to get matched with the right mentor for your journey
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Complete your application and tell us about your business goals
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Start your mentorship with regular sessions and ongoing support
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join our mentorship community and accelerate your entrepreneurial journey with expert guidance and support.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90">
