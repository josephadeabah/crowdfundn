  ...
  const trainingPrograms = [
    {
      ...
      description:
        'Comprehensive foundation course covering all aspects of starting and running a successful business in Africa.',
      modules: [
    ...
    },
    {
      ...
      description:
        'Master digital marketing strategies specifically designed for African markets and mobile-first audiences.',
      modules: [
    ...
    },
    {
      ...
      description:
        'Learn essential financial management skills and fundraising strategies for sustainable business growth.',
      modules: [
    ...
    },
    {
      ...
      description:
        'Intensive program for building scalable technology solutions for African markets.',
      modules: [
    ...
    },
    {
      ...
      description:
        'Learn how to integrate sustainability principles into your business model for long-term success.',
      modules: [
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Comprehensive training programs designed to equip African
              entrepreneurs with the skills needed to build successful,
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose from our comprehensive catalog of training programs, each
              designed to address specific entrepreneurial skills and
              challenges.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Hands-on training with real-world case studies and actionable
                  insights.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Learn from successful entrepreneurs and industry
                  professionals.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Content specifically designed for African markets and
                  challenges.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join thousands of African entrepreneurs who have transformed their
              businesses through our training programs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90">
                Enroll Today
