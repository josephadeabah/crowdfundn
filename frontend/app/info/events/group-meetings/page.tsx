...
import { Users, MapPin, Clock, Calendar, MessageCircle, Target, Network } from "lucide-react";
  ...
  const meetingGroups = [
    {
      ...
      description: "A supportive community for women entrepreneurs to share experiences, challenges, and celebrate successes together.",
      topics: ["Business scaling", "Work-life balance", "Funding strategies", "Networking"],
    ...
    },
    {
      ...
      description: "Connect with fellow tech entrepreneurs, share coding challenges, and discuss the latest trends in African tech.",
      topics: ["Product development", "Technical architecture", "User acquisition", "Funding rounds"],
    ...
    },
    {
      ...
      description: "For entrepreneurs building businesses that create positive social and environmental change.",
      topics: ["Impact measurement", "Sustainable business models", "Grant applications", "Community engagement"],
    ...
    },
    {
      ...
      description: "Bringing together entrepreneurs working on innovative solutions for Africa's agricultural challenges.",
      topics: ["Crop technology", "Supply chain innovation", "Farmer education", "Climate adaptation"],
    ...
    },
    {
      ...
      description: "A community for fintech entrepreneurs building the future of financial services in Africa.",
      topics: ["Digital payments", "Financial inclusion", "Regulatory compliance", "Blockchain applications"],
    ...
    },
    {
      ...
      description: "Supporting young entrepreneurs (18-30) with mentorship, resources, and peer learning opportunities.",
      topics: ["Business basics", "Funding options", "Marketing strategies", "Legal requirements"],
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join peer learning groups where African entrepreneurs connect, collaborate, and grow together through regular meetups and shared experiences.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">Why Join Group Meetings?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Share your goals with peers and stay motivated through regular check-ins and support.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Share experiences, challenges, and solutions with entrepreneurs facing similar journeys.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Active Group Meetings</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Join any of our specialized groups based on your industry, stage, or interests.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {meetingGroups.map((group) => (
              <Card key={group.id} className="border-border hover:shadow-lg transition-shadow">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{group.facilitator}</p>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <h3 className="text-lg font-semibold mb-2">{event.topic}</h3>
                        <p className="text-sm text-muted-foreground">
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">How Group Meetings Work</h2>
              <p className="text-muted-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Join regular meetings and participate in discussions and activities
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Build relationships, share knowledge, and support each other's growth
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Join a group meeting today and become part of Africa's most supportive entrepreneurial community.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary hover:bg-primary/90">
                Find Your Group
