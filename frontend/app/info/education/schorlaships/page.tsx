...
const Scholarship = () => {
  const scholarships = [
    ...
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/32711379/pexels-photo-32711379.jpeg',
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/12804469/pexels-photo-12804469.jpeg',
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/29558443/pexels-photo-29558443.jpeg',
    },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Investing in Africa's future through quality education for
              brilliant young minds across the continent.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-white/10 border-white hover:bg-white/10"
              >
                Learn More
              </Button>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 bg-green-50 rounded-lg">
              ...
              <div className="text-green-600">Scholarships Awarded</div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer various scholarship programs to support African youth in
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Meet some of our scholarship recipients who are making a
              difference
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Medicine Student, University of Ghana
                </p>
                <p className="text-gray-500">
                  "The scholarship allowed me to pursue my dream of becoming a
                  doctor without financial burden."
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500">
                  "This support enabled me to focus on my studies and develop an
                  app that helps farmers."
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500">
                  "The mentorship program connected me with industry leaders who
                  guided my career path."
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white/10 rounded-lg">
                ...
                <p className="text-blue-200">
                  Gather your academic records, recommendation letters, and
                  personal statement
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Apply today for a chance to receive full or partial scholarship
              for your education
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
