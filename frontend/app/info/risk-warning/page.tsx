          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                Commission (SEC) Ghana considers this investment to be high
                risk.
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="ml-11 space-y-3 text-gray-700">
              ...
              <p>
                ...
                well they are expected to perform, may not have been carried out
                by the platform you are investing through. You should do your
          ...
          <div className="mb-8">
            ...
            <div className="ml-11 space-y-3 text-gray-700">
              ...
              <p>
                ...
                is bought by another business or lists its shares on an exchange
                such as the Ghana Stock Exchange. These events are not common.
              </p>
              <p>
              ...
              <p>
                • BantuHive may work with companies to give you an opportunity
                to sell your investment early through a secondary sale, but
                there is no guarantee you will find a buyer at the price you are
                willing to sell.
              </p>
            </div>
          </div>
