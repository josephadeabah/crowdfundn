...
export const categoriesWithIcons: Category[] = [
  ...
  },
  {
    ...
    icon: <FaCloudSunRain className="w-4 h-4" />,
  },
  {
  ...
  },
  {
    ...
    icon: <FaFirstAid className="w-4 h-4" />,
  },
  {
    label: 'Cultural Preservation',
    value: slugify('Cultural Preservation'),
    icon: <FaMonument className="w-4 h-4" />,
  },
  {
  ...
  },
  {
    ...
    icon: <FaSolarPanel className="w-4 h-4" />,
  },
  {
    label: 'Environment',
  ...
  },
  {
    ...
    icon: <FaTractor className="w-4 h-4" />,
  },
  {
