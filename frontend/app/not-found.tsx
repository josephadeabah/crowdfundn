...
export default function NotFound() {
  ...
  const moods = {
    ...
    disappointed: {
      ...
      message:
        'The robot tried to find your page but got distracted by shiny things.',
      color: 'text-blue-600',
    ...
    cheerup: {
      ...
      message:
        'Every wrong turn is just a new opportunity to discover something amazing!',
  ...
  useEffect(() => {
    ...
    const randomMood =
      moodsArray[Math.floor(Math.random() * moodsArray.length)];
    setMood(randomMood);
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-screen p-6 transition-all duration-500 ${currentMood.bgColor}`}
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        {/* Content */}
        <h1
          className={`text-5xl md:text-7xl font-bold mb-6 ${currentMood.color} animate-pulse`}
        >
          {currentMood.title}
        </h1>
        ...
        <div className="mb-10 p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/70 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-sm">
                404 errors happen 20 million times per day worldwide
              </p>
            </div>
            <div className="p-4 bg-white rounded-lg shadow-sm">
              <div className="text-2xl mb-2">🕵️</div>
              <p className="text-sm">
                The first 404 was found by a programmer in 1992
              </p>
            </div>
            <div className="p-4 bg-white rounded-lg shadow-sm">
              <div className="text-2xl mb-2">🎯</div>
              <p className="text-sm">
                You're in good company - even Google has 404 pages!
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-blue-700">
                  "I tried my best! Can we try a different path together?"
                </p>
              </div>
            </div>
          </div>
          ...
          <button
            onClick={() => {
              const audio = new Audio(
                'https://assets.mixkit.co/sfx/preview/mixkit-cartoon-toy-whistle-616.mp3',
              );
              audio.play();
              triggerConfetti();
            }}
