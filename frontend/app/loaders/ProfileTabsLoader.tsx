...
const ProfileTabsLoader = () => {
  return (
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row h-screen">
      {/* Tabs Menu Skeleton */}
      <div className="w-full md:w-[13%] border-b h-auto md:h-screen md:border-b-0 md:border-r-2 border-dashed border-red-200">
      ...
      <div className="w-full bg-white px-4 overflow-auto flex-1 h-full md:h-screen">
