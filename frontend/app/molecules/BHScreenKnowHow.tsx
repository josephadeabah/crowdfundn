...
const BHScreenKnowHow: React.FC = () => {
  ...
  const imageItems: ImageItem[] = [
    ...
    },
    {
      ...
      detailedDescription:
        'Bantu Hive’s reward-based and gamified crowdfunding model allows you to earn exciting rewards for your contributions. Every donation, share, and engagement on the platform helps you accumulate points, unlock badges and an honorary certifications, and climb the leaderboard. Support others and get rewarded for your generosity!',
    },
    {
      id: 3,
    ...
    <div className="w-full max-w-7xl mx-auto p-4 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        {imageItems.slice(3, 5).map((item) => (
          <div key={item.id} className="relative bg-gray-50 p-2 rounded-lg">
            <img
              src={item.src}
              alt={item.title}
