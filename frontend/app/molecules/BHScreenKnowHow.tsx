    ...
    <div className="p-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {imageItems.slice(0, 3).map((item) => (
          <div
            key={item.id}
            className="relative bg-cyan-100 p-4 rounded-lg"
          >
            <img
              src={item.src}
              alt={item.title}
            ...
            <button
              className="absolute bottom-4 right-4 bg-cyan-300 text-white p-2 rounded-full hover:bg-cyan-300 transition-colors duration-200"
