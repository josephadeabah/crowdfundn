                    ...
                    <div className="w-full text-xs text-gray-600 dark:text-gray-300 py-2 flex flex-col">
                      <div className="flex justify-between items-center mb-2">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <span className="text-sm font-semibold sm:w-12 md:w-full truncate">
                      ...
                      <div className={`${index === 0 ? 'flex justify-between items-center': 'sm:flex-col sm:gap-2'} flex justify-between items-center sm:flex-col sm:gap-2 text-xs font-semibold text-gray-500 dark:text-gray-400 mt-2`}>
