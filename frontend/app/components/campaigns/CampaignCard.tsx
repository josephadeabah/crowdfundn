...
const CampaignCard: React.FC<CampaignCardProps> = ({
  ...
  return (
    <>
      ...
      />
      <div
        className="group relative overflow-hidden rounded-lg bg-background hover:shadow-md transition-all duration-300 animate-fade-up h-full flex flex-col text-xs"
      ...
      >
        ...
        >
          <div className="relative aspect-[4/2.5] overflow-hidden">
            ...
            <span className="absolute top-2 left-2 px-1.5 py-0.5 text-[10px] font-semibold bg-background/80 text-purple-500 rounded-md">
