...
const Hero = () => {
  ...
  <button className="group px-6 py-3 bg-green-600 text-primary-foreground rounded-md hover:bg-green-400 transition-colors flex items-center justify-center gap-2 whitespace-nowrap">
    <Link
  ...
  <button className="px-6 py-3 bg-transparent border border-border text-foreground rounded-md hover:bg-muted transition-colors whitespace-nowrap">
    <Link href="/how-it-works" className="whitespace-nowrap">How It Works</Link>
  </button>
</div>
