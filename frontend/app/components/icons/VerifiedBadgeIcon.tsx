...
const VerifiedBadgeIcon: React.FC<VerifiedBadgeIconProps> = ({
  ...
  return (
    <svg
      ...
      xmlSpace="preserve" // Use camelCase for React
      width={size}
      height={size}
