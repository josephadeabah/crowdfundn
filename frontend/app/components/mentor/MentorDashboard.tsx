...
const MentorDashboard: React.FC<MentorDashboardProps> = ({ mentorId }) => {
  ...
  const EditProfileModalContent = () => (
    <div className="space-y-4">
      ...
      <p className="text-gray-600 text-sm">
        This would normally load your profile editing form. For now, you can navigate to the full profile editor.
      </p>
      <div className="flex justify-end space-x-3 pt-4">
        <Button
          variant="outline"
  ...
  const ViewRequestsModalContent = () => (
    <div className="space-y-4">
      ...
      <p className="text-gray-600 text-sm">
        This would normally load available mentorship requests. For now, you can navigate to the full requests page.
      </p>
      <div className="flex justify-end space-x-3 pt-4">
        <Button
          variant="outline"
