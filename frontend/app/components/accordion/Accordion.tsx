...
>(({ children, className, ...props }, forwardedRef) => (
  <AccordionTrigger
    className={classNames(
      'group flex h-[45px] w-full break-words whitespace-normal flex-1 cursor-pointer items-center justify-between bg-white p-4 text-sm leading-none text-gray-700 outline-none hover:bg-gray-50',
      className,
    )}
    {...props}
    ref={forwardedRef}
