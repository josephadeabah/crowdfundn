...
const Privacy = () => {
  const tableOfContents = [
    ...
    { id: "fundraiser-accountability", title: "8. Fundraiser Accountability & Fund Misuse Penalties" },
  ...
  return (
    ...
    >
      ...
      <div id="introduction" className="policy-section">
        ...
        <p>
          Welcome to BantuHive Ltd ("the Company," "we," "us," or "our"). This Privacy Policy 
          explains how we collect, use, disclose, and safeguard your information when you use our 
          donations and investment crowdfunding platform, including our website at www.bantuhive.com 
        ...
        <p>
          BantuHive Ltd is committed to protecting your privacy and ensuring that your personal 
          information is handled in a safe and responsible manner. We comply with the Data Protection 
          Act, 2012 (Act 843) of Ghana and implement industry-standard security measures to protect 
          your data.
        </p>
        <h3>1.2 Scope</h3>
        <p>
      ...
      <div id="information-collected" className="policy-section">
        ...
        <p>
          When you register for an account, create a campaign, or make a donation or investment, we 
          collect information you directly provide, including:
        </p>
        <ul>
          ...
          <li><strong>Identification Documents:</strong> Ghana Card number, passport, driver's license (for KYC verification)</li>
          <li><strong>Financial Information:</strong> Bank account details, mobile money numbers, payment card information</li>
          <li><strong>Profile Information:</strong> Profile photo, biography, social media links</li>
          <li><strong>Campaign Information:</strong> Campaign descriptions, images, videos, beneficiary details</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Log Information:</strong> IP address, access times, pages viewed, referring URL</li>
          <li><strong>Location Information:</strong> General location based on IP address, precise location if you grant permission</li>
          <li><strong>Usage Information:</strong> Features used, actions taken, transaction history</li>
        </ul>
      ...
      <div id="information-sharing" className="policy-section">
        ...
        <p>
          We share information when you have given us explicit consent, such as when you choose to 
          make your donation public or share campaign updates.
        </p>
        ...
        <ul>
          ...
          <li>To comply with anti-money laundering and counter-terrorism financing regulations</li>
          <li>To protect our legal rights or defend against legal claims</li>
        </ul>
        <h3>4.4 Campaign Transparency</h3>
        <p>
          Certain information may be visible to other users for platform transparency:
        </p>
        <ul>
          <li>Fundraiser profiles and campaign information are public</li>
          <li>Donor names may be displayed unless you choose to donate anonymously</li>
          <li>Investment amounts may be visible to campaign organizers</li>
        </ul>
        <h3>4.5 Business Transfers</h3>
        <p>
          In the event of a merger, acquisition, or sale of assets, your information may be 
          transferred as part of that transaction. We will notify you of any such change and 
      ...
      <div id="cookies" className="policy-section">
        ...
        <p>
          Cookies are small text files stored on your device when you visit our Platform. We use 
          cookies and similar technologies to enhance your experience, analyze usage, and provide 
        ...
        <ul>
          <li>
            ...
            These enable core features like security, session management, and accessibility.
          </li>
          <li>
            <strong>Performance Cookies:</strong> Help us understand how users interact with the 
            Platform by collecting anonymous usage data.
          </li>
          <li>
            <strong>Functionality Cookies:</strong> Remember your preferences and settings to 
            provide a more personalized experience.
          </li>
          <li>
            <strong>Marketing Cookies:</strong> Track your activity across websites to deliver 
            relevant advertisements (only with your consent).
          </li>
        </ul>
        <h3>5.3 Managing Cookies</h3>
        <p>
          You can control cookies through your browser settings. Please note that disabling certain 
          cookies may affect the functionality of our Platform. You can also manage your cookie 
        ...
        <p>
          ...
          signals, but we respect your privacy choices through our cookie preference settings.
        </p>
      </div>
      ...
      <div id="data-security" className="policy-section">
        ...
        <p>
          While we take extensive measures to protect your data, you also play a role in keeping 
          your account secure:
        </p>
        <ul>
      ...
      <div id="your-rights" className="policy-section">
        ...
        <p>
          Under the Data Protection Act, 2012 (Act 843) and our commitment to your privacy, you 
          have the following rights:
        </p>
        <h3>7.1 Right to Access</h3>
        <p>
          You can request a copy of the personal information we hold about you. We will provide 
          this information within 30 days of receiving your request.
        </p>
        ...
        <p>
          ...
          Some data may need to be retained for regulatory compliance.
        </p>
        ...
        <p>
          You can request your data in a commonly used, machine-readable format to transfer to 
          another service.
        </p>
        <h3>7.6 Right to Object</h3>
        <p>
          You can object to processing of your personal data for marketing purposes at any time. 
          You can unsubscribe from marketing communications using the link in our emails or through 
          your account settings.
        </p>
        <h3>7.7 Exercising Your Rights</h3>
        <p>
          To exercise any of these rights, please contact us at privacy@bantuhive.com or through 
          your account settings. We will verify your identity before processing your request.
        </p>
      </div>
      ...
      <div id="fundraiser-accountability" className="policy-section">
        ...
        <p>
          BantuHive Ltd maintains strict policies to ensure all funds raised on our platform are 
          used for their intended purposes. Misuse of funds—whether from donations or investments—
          constitutes a serious violation subject to civil and criminal penalties under Ghanaian law.
        </p>

        <h3>8.1 Applicable Ghana Laws</h3>
        <p>
          Fund misuse may result in prosecution under the following laws:
        </p>
        <ul>
          <li>
            <strong>Criminal Offences Act, 1960 (Act 29):</strong> Fraud and defrauding by false 
            pretenses carry penalties of up to 10 years imprisonment.
          </li>
          <li>
            <strong>Anti-Money Laundering Act, 2020 (Act 1044):</strong> Fund misappropriation 
            constituting money laundering is punishable by up to 10 years imprisonment and/or 
            substantial fines.
          </li>
          <li>
            <strong>Securities Industry Act, 2016 (Act 929):</strong> Investment fraud is subject 
            to SEC enforcement, including fines and imprisonment up to 10 years.
          </li>
          <li>
            <strong>Electronic Transactions Act, 2008 (Act 772):</strong> Online fraud carries 
        ...
        <ul>
          ...
          <li>Provide progress updates and proof of fund usage when requested</li>
          <li>Return unused funds or obtain donor/investor consent for alternative use</li>
        ...
        <ul>
          <li>Immediate suspension of account and freezing of pending disbursements</li>
        ...
        <ul>
          <li>Imprisonment ranging from 2 to 15 years depending on the offense and amount</li>
        ...
        <p>
          We actively monitor campaigns and fund usage through:
        </p>
        <ul>
          <li>Enhanced due diligence and identity verification for all fundraisers</li>
        ...
        <p>
          BantuHive Ltd cooperates fully with law enforcement and regulatory bodies including:
        </p>
        <ul>
          <li>Ghana Police Service (EOCO - Economic and Organized Crime Office)</li>
        ...
        <p>
          If you suspect fund misuse, please report it immediately:
        </p>
        <ul>
          <li><strong>Email:</strong> compliance@bantuhive.com</li>
          <li><strong>Hotline:</strong> +233 XX XXX XXXX (available 24/7)</li>
          <li><strong>Online:</strong> Through the "Report Campaign" feature on any campaign page</li>
        </ul>
        <p>
          All reports are treated confidentially, and whistleblowers are protected from retaliation 
          under the Whistleblowers Act, 2006 (Act 720).
        </p>
      </div>
      ...
      <div id="childrens-privacy" className="policy-section">
        ...
        <p>
          ...
          personal information from children under 18 years of age. If you are a parent or guardian 
        ...
        <p>
          While children cannot use our Platform directly, fundraising campaigns may benefit children. 
          In such cases:
        </p>
        <ul>
          <li>The campaign must be created by a parent, guardian, or authorized adult</li>
          <li>We limit the disclosure of identifying information about child beneficiaries</li>
          <li>Parental consent is required for any information relating to the child</li>
        </ul>
      </div>
      ...
      <div id="third-party-links" className="policy-section">
        ...
        <p>
          ...
          are not operated by us. This Privacy Policy does not apply to those third-party services.
        </p>
        <h3>10.1 Third-Party Services We Integrate</h3>
        <ul>
          <li><strong>Payment Providers:</strong> Mobile money operators, banks, card networks</li>
          <li><strong>Social Media:</strong> Facebook, Twitter, LinkedIn, Instagram</li>
        ...
        <p>
          We encourage you to review the privacy policies of any third-party websites or services 
          before providing your personal information. We are not responsible for the privacy 
      ...
      <div id="payment-processing" className="policy-section">
        ...
        <p>
          Payment information is processed by our PCI-DSS compliant payment partners. We do not 
          store complete payment card numbers on our servers. All payment transactions are encrypted 
          and processed securely.
        </p>
        <h3>11.3 Financial Information Retention</h3>
        <p>
          We retain transaction records as required by law and for dispute resolution purposes. 
          Bank account and mobile money numbers are stored securely for processing payouts to 
          fundraisers.
        </p>
      </div>
      ...
      <div id="changes" className="policy-section">
        ...
        <p>
          Your continued use of our Platform after any changes to this Privacy Policy constitutes 
          your acceptance of those changes. We encourage you to review this Privacy Policy 
          periodically.
        </p>
      </div>
      ...
      <div id="contact" className="policy-section">
        ...
        <ul>
          <li><strong>Email:</strong> privacy@bantuhive.com</li>
          <li><strong>Address:</strong> BantuHive Ltd, [Address], Accra, Ghana</li>
          <li><strong>Website:</strong> www.bantuhive.com/contact</li>
        </ul>
        ...
        <ul>
          <li><strong>Address:</strong> No. 7 Olusegun Obasanjo Way, Airport Residential Area, Accra</li>
          <li><strong>Website:</strong> www.dataprotection.org.gh</li>
        </ul>
        <p className="mt-8 p-4 bg-muted rounded-lg">
          <strong>Document Information</strong><br />
          Version: 1.0<br />
          Effective Date: January 14, 2025<br />
          Next Review Date: January 14, 2026<br />
