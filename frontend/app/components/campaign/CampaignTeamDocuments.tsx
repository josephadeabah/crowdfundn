...
<div className="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
  <div className="flex justify-between items-center mb-2">
    ...
    <span className="text-sm">
      {totalAllocatedEquity.toFixed(1)}% of {availableEquity.toFixed(1)}% allocated
    </span>
  </div>
  ...
  <div className="text-xs text-gray-500 mt-1">
    {Math.max(0, remainingEquity).toFixed(1)}% remaining for team members
  </div>
</div>
...
<div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
  <div className="flex justify-between items-center mb-2">
    ...
    <span className="text-sm font-semibold">{Math.max(0, remainingEquity).toFixed(1)}%</span>
  </div>
  <div className="text-xs text-blue-600 dark:text-blue-300">
    Campaign equity offered: {campaignEquityOffered.toFixed(1)}% | Total allocated to team: {totalAllocatedEquity.toFixed(1)}%
  </div>
</div>
