...
const Footer = () => {
  return (
    <footer className="relative bg-green-100 text-gray-600 py-16">
      {/* Background Image */}
      <div className="absolute inset-0  bg-cover opacity-10" style={{ backgroundImage: "url('/Team-spirit-bro.svg')" }}></div>
