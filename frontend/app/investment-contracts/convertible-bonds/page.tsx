            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  ...
                  into a predetermined number of equity shares at specific times
                  during the bond's life. They combine features of both debt and
                  equity investments.
                </p>
                <p className="text-muted-foreground">
                ...
                <div className="bg-trust/5 border border-trust/20 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    shares if the company's value increases significantly. This
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive regular interest payments (coupon) throughout the
                      bond's term, typically at lower rates than traditional
                      bonds due to conversion option.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-foreground">
                    ...
                    <p className="text-sm text-muted-foreground">
                      If you convert to shares and the company value increases,
                      you benefit from capital appreciation just like equity
                      shareholders.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>
                      • If share price rises to GHS 15: Convert to shares worth
                      GHS 7,500 (50% gain)
                    </li>
                  </ul>
                </div>
