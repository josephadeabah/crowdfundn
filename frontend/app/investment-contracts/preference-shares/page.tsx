...
import { ArrowLeft, Shield, DollarSign, AlertTriangle, CheckCircle, Info, Clock } from "lucide-react";
      ...
      <div className="bg-gradient-to-br from-trust/10 via-background to-growth/5 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-foreground">Preference Shares</h1>
              <p className="text-muted-foreground">Priority shares with fixed dividend rates</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-3">
            <Badge variant="secondary" className="bg-success/10 text-success">Medium Risk</Badge>
            <Badge variant="secondary" className="bg-trust/10 text-trust">Fixed Dividends</Badge>
            <Badge variant="secondary" className="bg-growth/10 text-growth">Priority Rights</Badge>
          </div>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Preference shares are a type of equity that gives holders preferential treatment over ordinary shareholders. 
                  They typically offer fixed dividend rates and priority in receiving dividends and assets during liquidation.
                </p>
                <p className="text-muted-foreground">
                  In Ghana's investment landscape, preference shares provide a middle ground between debt and equity investments, 
                  offering more predictable returns than ordinary shares while still providing ownership in the company.
                </p>
                <div className="bg-trust/5 border border-trust/20 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Preference shareholders receive dividends before ordinary shareholders and have priority claims 
                    on company assets if the business is liquidated.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h4 className="font-semibold text-foreground">Fixed Dividends</h4>
                    <p className="text-sm text-muted-foreground">
                      Receive predetermined dividend rates, typically higher than ordinary shares. 
                      These are paid before any dividends to ordinary shareholders.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-foreground">Capital Appreciation</h4>
                    <p className="text-sm text-muted-foreground">
                      Limited capital growth potential compared to ordinary shares, but more stable 
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    If you invest GHS 2,000 in preference shares with a 8% fixed dividend rate, 
                    you'll receive GHS 160 annually in dividends, regardless of company performance (as long as profits allow).
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="border border-border p-4 rounded-lg">
                      <h5 className="font-medium text-foreground mb-2">Cumulative</h5>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="border border-border p-4 rounded-lg">
                      <h5 className="font-medium text-foreground mb-2">Redeemable</h5>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="space-y-4">
                    <div className="border border-border p-4 rounded-lg">
                      <h5 className="font-medium text-foreground mb-2">Non-Cumulative</h5>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="border border-border p-4 rounded-lg">
                      <h5 className="font-medium text-foreground mb-2">Convertible</h5>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h5 className="font-medium text-foreground">Priority Dividends</h5>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-success mt-0.5" />
                      <div>
                        <h5 className="font-medium text-foreground">Liquidation Priority</h5>
                        <p className="text-sm text-muted-foreground">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-success mt-0.5" />
                      <div>
                        <h5 className="font-medium text-foreground">Fixed Returns</h5>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h5 className="font-medium text-foreground">Limited Voting</h5>
                        <p className="text-sm text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    <h5 className="font-medium text-warning mb-2">Limited Growth Potential</h5>
                    <p className="text-sm text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Dividend Priority:</span>
                ...
                <Link href="/equity-shares">
                  <Button variant="ghost" className="w-full justify-start text-left h-auto p-3">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Higher growth potential</div>
                    </div>
                  </Button>
                </Link>
                <Link href="/convertible-bonds">
                  <Button variant="ghost" className="w-full justify-start text-left h-auto p-3">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Debt with conversion option</div>
                    </div>
                  </Button>
                </Link>
              </CardContent>
