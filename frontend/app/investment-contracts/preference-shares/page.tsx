              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    ...
                    typically offer fixed dividend rates and priority in
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        than ordinary shares. These are paid before any
                  ...
                  <div className="bg-muted/30 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      If you invest GHS 2,000 in preference shares with a 8%
                      fixed dividend rate, you'll receive GHS 160 annually in
                      dividends, regardless of company performance (as long as
                      profits allow).
                    </p>
                  </div>
                </CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="border border-border p-4 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          If dividends aren't paid in a year, shareholders
                          forfeit that year's dividend permanently.
                        </p>
                      </div>
