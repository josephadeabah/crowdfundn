          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  This investment structure is particularly popular in Ghana for
                  supporting local businesses, especially in sectors like
                  agriculture, manufacturing, and services where revenue streams
                  are predictable.
                </p>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Payments are usually made monthly or quarterly, providing
                      regular income that fluctuates with business performance.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  ...
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Revenue sharing is highly sensitive to economic downturns
