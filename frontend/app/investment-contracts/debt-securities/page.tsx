              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    ...
                    obligated to pay you regular interest payments and return
                  ...
                  <div className="bg-trust/5 border border-trust/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Debt securities provide capital preservation and
                      predictable income streams, making them ideal for
                      conservative investors seeking stable returns with lower
                      volatility.
                    </p>
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground mb-4">
                    ...
                    and help investors understand the risk level:
                  </p>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Fixed interest payments lose purchasing power if
                        inflation exceeds the interest rate.
                      </p>
                    </div>
