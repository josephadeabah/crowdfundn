          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Debt securities are fixed-income investments where you lend
                  money to a company or government entity for a predetermined
                  period at a fixed interest rate. The borrower is legally
                  obligated to pay you regular interest payments and return your
                  principal amount at maturity.
                </p>
                <p className="text-muted-foreground">
                  In Ghana's investment landscape, debt securities include
                  corporate bonds, government bonds, commercial papers, and
                  other fixed-income instruments that provide predictable
                  returns with lower risk compared to equity investments.
                </p>
                <div className="bg-trust/5 border border-trust/20 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Debt securities provide capital preservation and predictable
                    income streams, making them ideal for conservative investors
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive regular interest payments at predetermined rates
                      and intervals, typically semi-annually or annually.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-semibold text-foreground">
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    <p>
                      <strong>Investment:</strong> GHS 10,000 in 3-year
                      corporate bond at 12% annual interest
                    </p>
                    <p>
                      <strong>Annual Interest:</strong> GHS 1,200 (12% of GHS
                      10,000)
                    </p>
                    <p>
                      <strong>Total Interest Over 3 Years:</strong> GHS 3,600
                    </p>
                    <p>
                      <strong>Principal at Maturity:</strong> GHS 10,000
                    </p>
                    <p>
                      <strong>Total Return:</strong> GHS 13,600 (36% total
                      return over 3 years)
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="border border-border p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Issued by Bank of Ghana. Lowest risk with moderate
                        returns. Include Treasury Bills and Government Bonds.
                      </p>
                    </div>
                    ...
                    <div className="border border-border p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Issued by companies. Higher returns than government
                        bonds but with increased credit risk.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="border border-border p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Short-term unsecured promissory notes, typically with
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Fixed interest payments provide steady, predictable
                          cash flow
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Bondholders are paid before equity shareholders if
                          company fails
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Can be bought and sold on secondary markets before
                          maturity
                        </p>
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground mb-4">
                  Credit ratings assess the creditworthiness of bond issuers and
                  help investors understand the risk level:
                </p>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Risk that the issuer may default on interest payments or
                      principal repayment.
                    </p>
                  </div>
                  ...
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Bond values decline when interest rates rise, affecting
                  ...
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Fixed interest payments lose purchasing power if inflation
                  ...
                  <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Some bonds may be difficult to sell quickly without
