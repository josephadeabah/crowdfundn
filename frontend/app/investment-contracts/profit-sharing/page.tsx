              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    particularly in sectors like agriculture processing,
                  ...
                  <div className="bg-trust/5 border border-trust/20 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      sharing is calculated after deducting all business
                      expenses, taxes, and operational costs. This means higher
                      potential returns but also higher dependency on efficient
                      business management.
                    </p>
                  </div>
                </CardContent>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border border-border p-4 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          more frequent but potentially less accurate
                          distributions.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Can generate significant returns if business is
                            highly profitable
                          </p>
                        </div>
                      </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted/20 border border-border p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        How expenses are classified and depreciation is
                        calculated significantly impacts net profit.
                      </p>
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    <div className="bg-warning/5 border border-warning/20 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Profits can fluctuate significantly - no profits means
                        no returns, regardless of revenue levels.
                      </p>
                    </div>
