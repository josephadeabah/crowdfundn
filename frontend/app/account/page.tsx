...
const ProfileTabs = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-800 flex flex-col md:flex-row h-screen">
      {/* Tabs Menu */}
      <div className="md:w-1/6 border-b md:border-b-0 md:border-r-2 border-dashed border-orange-200 dark:border-neutral-700">
        <div
