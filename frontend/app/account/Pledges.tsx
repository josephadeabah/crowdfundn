          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="relative w-full md:w-1/3 h-48">
                <Image
                  src={pledge.selected_rewards[0]?.image || '/placeholder-image.jpg'}
              ...
              <div className="flex-1 p-6">
                ...
                <p className="text-gray-600 mb-4">
                  {pledge.selected_rewards[0]?.description || 'No Reward Description'}
                </p>

                {/* Pledge Details */}
                <div className="space-y-2">
                  <p className="text-sm text-gray-700">
                    <span className="font-medium">Amount:</span> ₵{pledge.amount}
                  </p>
                  <p className="text-sm text-gray-700">
                ...
                {pledge.shipping_data && (
                  <div className="mt-4 border-t pt-4">
                    ...
                    <p className="text-sm text-gray-700">{pledge.shipping_data.shippingAddress}</p>
                  </div>
                )}
