  ...
  return (
    <div className="px-2 py-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card className="p-4 bg-white rounded-lg border-none shadow hover:bg-gray-100 transition-shadow duration-200 relative">
          ...
          <CardDescription>
            <div className="flex flex-col gap-2">
              {[
                ...
                <div
                  key={index}
                  className="p-4 bg-gray-100 rounded-lg w-full flex justify-between items-center"
                >
